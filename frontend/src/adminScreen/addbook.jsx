...
export default function AddBook() {
    ...
    //         setbookData((prevData) => ({ ...prevData, front_image: base64String }));
    //         setbookData((prevData) => ({ ...prevData, back_image: base64String }));
    //         setImage(base64String);
    //         bookData.front_image = base64String;
    //         bookData.back_image = base64String;
